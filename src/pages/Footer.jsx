        ...
        <div className="max-w-7xl mx-auto grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-8 text-sm text-gray-700">
          ...
          <div>
            ...
            <ul className="space-y-1">
              ...
              <li><Link to="/Nonteaching" className="hover:text-blue-600">Non-Teaching</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-1">
              <li><Link to="/student-corner/eresources" className="hover:text-blue-600">E-Resources</Link></li>
